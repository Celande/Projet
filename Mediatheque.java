...
public class Mediatheque implements ActionListener
{
	...
	public void addDocument()
	{
		...
		if(!docList.contains(d)) 
		{
			...
			{
				System.err.println("Le genre est déjà dans la base de données : ");
				System.err.println(genreList());
			}
		}
		else
		{
			System.err.println("Le document est déjà dans la base de données : ");
			System.err.println(d);
		}
	}
	
	public void consultDoc(String tri)
	{
		System.out.println("Par quelle catégorie voulez-vous consulter la liste des documents\n g --> (g)enres\n l --> (l)ocalisaion\n a --> (a)lphabetique\n w --> (au)teur");
		if(tri = 'g')
		{
